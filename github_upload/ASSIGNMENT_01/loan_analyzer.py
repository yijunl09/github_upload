...
print("the number of length is:", loan_costs_length )
...
print("the total value of the loan is:", loan_costs_sum)
...
print("the average loan value is:", loan_costs_average)
...
print("future_value is:", loan["future_value"])
print("remaining_months is:", loan["remaining_months"])
...
fv = loan["future_value"]
rm = loan["remaining_months"]
pv = int(fv / (1+0.2/12) ** rm)
